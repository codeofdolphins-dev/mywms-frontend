...
function FileUpload({
  ...
  return (
    <div className="space-y-1">
      ...
      <div
        className="flex items-center w-full border border-gray-300 rounded-md bg-white px-3 py-2 shadow-sm
                   focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 cursor-pointer"
